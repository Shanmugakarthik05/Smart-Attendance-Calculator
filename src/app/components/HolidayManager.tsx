...
import { Timetable, DAYS, TIME_SLOTS } from "./TimetableManager";
...
export function HolidayManager({
  ...
  useEffect(() => {
    if (startDate && endDate) {
      setAutoResult(computeAutoHours(startDate, endDate, timetable, subjects));
    } else {
      setAutoResult({ cancelledHours: [], breakdown: [] });
    }
  }, [startDate, endDate, timetable, subjects]);
